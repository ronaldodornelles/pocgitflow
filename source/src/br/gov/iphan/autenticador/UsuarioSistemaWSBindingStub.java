...
public class UsuarioSistemaWSBindingStub
extends Stub
implements UsuarioSistemaWS {
    ...
    static {
        UsuarioSistemaWSBindingStub._initOperationDesc1();
    }

    private static void _initOperationDesc1() {
        OperationDesc oper = new OperationDesc();
        oper.setName("autenticaUsuario");
        ParameterDesc param = new ParameterDesc(new QName("", "arg0"), (byte) 1, new QName("http://www.w3.org/2001/XMLSchema", "string"), (Class)String.class, false, false);
        ...
        UsuarioSistemaWSBindingStub._operations[0] = oper;
        oper = new OperationDesc();
        oper.setName("pesquisaDadosUsuario");
        ...
        oper.setStyle(Style.WRAPPED);
        oper.setUse(Use.LITERAL);
        UsuarioSistemaWSBindingStub._operations[1] = oper;
    }

    public UsuarioSistemaWSBindingStub() throws AxisFault {
        this(null);
    }

    public UsuarioSistemaWSBindingStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public UsuarioSistemaWSBindingStub(Service service) throws AxisFault {
    ...
    public String autenticaUsuario(String arg0, String arg1, String arg2) throws RemoteException {
        ...
        _call.setOperationName(new QName("http://ws.siscau.iphan.gov.br/", "autenticaUsuario"));
    ...
    public String pesquisaDadosUsuario(String arg0) throws RemoteException {
        ...
        _call.setProperty("sendMultiRefs", (Object)Boolean.FALSE);
        _call.setSOAPVersion((SOAPConstants)SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new QName("http://ws.siscau.iphan.gov.br/", "pesquisaDadosUsuario"));
        this.setRequestHeaders(_call);
        this.setAttachments(_call);
