...
{
    self.location.href=$axure.globalVariableProvider.getLinkUrl('Incluir___Forma_ao_Academica.html');
}
...
{
    window.open($axure.globalVariableProvider.getLinkUrl('Incluir___Forma_ao_Academica.html'));
}
...
{
    self.location.href=$axure.globalVariableProvider.getLinkUrl('Editar___Forma_ao_Academica.html');
}
...
{
    window.open($axure.globalVariableProvider.getLinkUrl('Editar___Forma_ao_Academica.html'));
}
...
{
    self.location.href=$axure.globalVariableProvider.getLinkUrl('Visualizar___Forma_ao_Academica.html');
}
...
{
    window.open($axure.globalVariableProvider.getLinkUrl('Visualizar___Forma_ao_Academica.html'));
}
