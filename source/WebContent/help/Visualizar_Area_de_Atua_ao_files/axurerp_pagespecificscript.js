...
{
    self.location.href=$axure.globalVariableProvider.getLinkUrl('Pesquisar_Area_de_Atua_ao.html');
}
...
{
    window.open($axure.globalVariableProvider.getLinkUrl('Pesquisar_Area_de_Atua_ao.html'));
}
