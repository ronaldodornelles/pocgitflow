...
{
    self.location.href=$axure.globalVariableProvider.getLinkUrl('Editar_Area_de_Atua_ao.html');
}
...
{
    window.open($axure.globalVariableProvider.getLinkUrl('Editar_Area_de_Atua_ao.html'));
}
...
{
    self.location.href=$axure.globalVariableProvider.getLinkUrl('Visualizar_Area_de_Atua_ao.html');
}
...
{
    window.open($axure.globalVariableProvider.getLinkUrl('Visualizar_Area_de_Atua_ao.html'));
}
