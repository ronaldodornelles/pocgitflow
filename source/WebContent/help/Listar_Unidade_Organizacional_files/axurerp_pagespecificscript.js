...
{
    self.location.href=$axure.globalVariableProvider.getLinkUrl('Visualizar_Unidade_Organizacional.html');
}
...
{
    window.open($axure.globalVariableProvider.getLinkUrl('Visualizar_Unidade_Organizacional.html'));
}
